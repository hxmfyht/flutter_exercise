...
class InputBoxWidget extends StatefulWidget {
  ...
  InputBoxWidget({required this.body,required this.callback});

  @override
  _InputBoxWidgetState createState() => _InputBoxWidgetState();
}

class _InputBoxWidgetState extends State<InputBoxWidget> with WidgetsBindingObserver{
...
@override
  ...
  Widget build(BuildContext context) {
          ...
          children:[
            ...
            Row(
              children: [
                Expanded(
                  child: Container(
                    margin: EdgeInsets.only(left: 16,bottom: 6,top: 6,right: 6),
    ...
    //                 },
    //                 child: _keyboardBtn
    //                     ?Icon(Icons.add_circle):Icon(Icons.margin)
    //                 // WebsafeSvg.asset("assets/keyboard.svg", width: 32, height: 32)
    //                 //     :WebsafeSvg.asset("assets/laugh.svg", width: 32, height: 32)
    // ),
  ...
  /// 获取键盘高度
  _getBottom(){
    print("键盘高度${MediaQueryData.fromWindow(WidgetsBinding.instance!.window).viewInsets.bottom}");
